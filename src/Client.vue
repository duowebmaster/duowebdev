  ...
  <v-flex xs12>
    ...
    <v-container>
      <v-layout row justify-space-between wrap fill-height>
        <v-flex xs12>
          <p class="intro" :style="this.config.profile.content.style">
            {{this.content}}
          </p>
        </v-flex>
      </v-layout>
    ...
    <v-container>
      <v-layout row justify-space-between wrap fill-height>
        <v-flex v-bind="{[`xs4`]:!isMobile,[`xs6`]:isMobile}" style="text-align: center">
          <img :src="this.config.profile.clients.src" :style="this.config.profile.clients.style"/>
        </v-flex>
      </v-layout>
    </v-container>
  </v-flex >
